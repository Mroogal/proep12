...
class Side_Fin: public Drawing_Element{
    public:
    virtual void draw(int j,std::ofstream& c){
    if(j==1)
c << "<path d=\"M476.92 299.2L448.39 315.84L448.39 281.36L476.92 299.2Z\" id=\"c4vE7TzebC\"/><use xlink:href=\"#c4vE7TzebC\" opacity=\"1\" fill=\"#43f8f0\" fill-opacity=\"1\"/>";
    if(j==2)
